...
QT_MOC_LITERAL(1, 15, 14), // "SignalUpdateUi"
QT_MOC_LITERAL(2, 30, 0) // ""

    },
    "GameController\0SignalUpdateUi\0"
};
...
void GameController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameController::SignalUpdateUi)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GameController::SignalUpdateUi()
{
